...
public class DataExampleController implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, null, true));
        articleRepository.save(new Article("spain", "Pene pene", article_content, editor, "http://www.mifuente.com", tags, null, true));
        articleRepository.save(new Article("spain", "Calvo", article_content, editor, "http://www.mifuente.com", tags, null, true));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, null, true));
        articleRepository.save(new Article("spain", "Pene pene", article_content, editor, "http://www.mifuente.com", tags, null, true));
        articleRepository.save(new Article("spain", "Calvo", article_content, editor, "http://www.mifuente.com", tags, null, true));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, null, true));
