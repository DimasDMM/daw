...
public class DataExampleController implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, 1, dateInsert));

        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, 0, dateInsert));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, 0, dateInsert));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, 0, dateInsert));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, 0, dateInsert));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, 0, dateInsert));
