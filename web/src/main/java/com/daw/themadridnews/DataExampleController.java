...
public class DataExampleController implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, true));

        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, false));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, false));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, false));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, false));
        articleRepository.save(new Article("madrid", "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, false));
