...
public class DataExampleController implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        articleCategoryRepository.save( new ArticleCategory("world", "Mundo") );
        articleCategoryRepository.save( new ArticleCategory("sport", "Deportes") );
        articleCategoryRepository.save( new ArticleCategory("technology", "Tecnología") );
        articleCategoryRepository.save( new ArticleCategory("culture", "Cultura") );
        ...
        ArticleCategory article_category = articleCategoryRepository.findOne("spain");
        ...
        articleRepository.save(new Article(article_category, "El alicatador sigue fugado", article_content, editor, "http://www.mifuente.com", tags, null, true));
